...
\begin{posterbox}[name=references,column=0,below=methods]{References}
  ...
  \end{posterbox}
%%%%%%%%%%%%%%% Anno Logo
 \node [anchor=south east, inner sep=1pt,xshift=-27em] at (current page.south east)
 {\includegraphics[height=0.03\textheight]{img/anno-logo.pdf}
 };
%%%%%%%%%%%%%%% IMISE Logo
 \node [anchor=south east, inner sep=1pt,xshift=-10em] at (current page.south east)
